#!/usr/bin/env python3
"""Build the estimation panel: CEPII BACI HS6 trade merged with the EU
sanctions product list.

Inputs
  phase3_data/BACI_HS92_V202601/BACI_HS92_Y{year}_V202601.csv  (2015-2024)
  phase3_data/raw/EU_sanctions_HS6.dta                          (Chupilkin et al.)
  phase3_data/BACI_HS92_V202601/country_codes_V202601.csv

Outputs
  phase4_analysis/processed/baci_russia_panel.parquet   Russia-facing HS6 panel
  phase4_analysis/processed/sanctions_hs6_master.csv    sanctioned-code master

Every other script in this package reads the parquet panel, so run this first.
Pre-analysis rules: phase4_analysis/B0_preanalysis_rules.md
"""
...
OUTPUT_DIR = Path('phase4_analysis/processed')
...
def load_sanctions_hs6():
    ...
    eu = pd.read_stata('phase3_data/EU_sanctions_HS6.dta')
